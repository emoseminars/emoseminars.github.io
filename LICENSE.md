...
biographies, photographs, recordings, written site content, graphics, logos,
and other branding materials.

**All rights reserved.** No permission is granted to copy, redistribute, adapt,
or republish these materials except with permission from the applicable rights
holder or as otherwise permitted by law. Public availability of this repository
does not place those materials in the public domain.

## Website software

The Jekyll, Liquid, HTML, and Sass implementation is derived in part from
`mjungmath/jekyll-seminar` and `jekyll/minima`. Those software portions are
